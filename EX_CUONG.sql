...
select architect.name, architect.birthday from architect order by architect.name ASC, architect.birthday ASC;

select architect.name, architect.birthday from architect order by architect.name desc, architect.birthday desc;

select cost from building order by building.cost asc,building.city asc;

select * from architect where architect.name='le thanh tung';


select worker.name,worker.birthday from worker where worker.skill in('han','dien');

select worker.name,worker.birthday from worker where worker.skill in('han','dien') and worker.birthday > 1948;

select * from worker where worker.birthday + 20 > worker.year;

select * from worker where worker.birthday in('1945','1940','1948');
select * from worker where worker.birthday ='1945' or worker.birthday ='1940' or worker.birthday ='1948';

select * from building where building.cost between 200 and 500;
select * from building where building.cost >= 200 and building.cost < 500;


select * from architect where architect.name like 'nguyen %';

select * from architect where architect.name like '%anh%';

select * from architect where architect.name like '%th_';
